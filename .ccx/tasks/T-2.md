...
# Per-document progress display (CLI)
...
- include: [src/mdpo_llm/processor.py, src/mdpo_llm/__main__.py, tests/test_batched_processing.py, README.md, CHANGELOG.md, pyproject.toml]
- exclude: []
