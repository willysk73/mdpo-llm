...
# Refine mode + inplace deprecation
...
- include: [src/mdpo_llm/processor.py, src/mdpo_llm/prompts.py, src/mdpo_llm/validator.py, src/mdpo_llm/__main__.py, src/mdpo_llm/__init__.py, tests/test_batched_processing.py, tests/test_validator.py, README.md, CHANGELOG.md]
- exclude: []
...
- Removing `inplace` entirely — emit DeprecationWarning only. Hard removal is v0.5.
